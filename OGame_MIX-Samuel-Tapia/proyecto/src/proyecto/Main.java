...
botonesReport[0].addActionListener(new ActionListener() {
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			int numBattleReport = Integer.parseInt(getMessage);
			System.out.println("Elegiste la batalla "+numBattleReport);
			if (numBattleReport > 5){
				JOptionPane.showMessageDialog(panelBattleReport,"La batalla con ID "+numBattleReport+" no existe tolay");
				...
				JLabel tituloReportedBattle2 = new JLabel("BATTLE",SwingConstants.CENTER);
				...
				panelReportedBattle.add(scrollPane);
			}
		} catch (Exception e1) {
